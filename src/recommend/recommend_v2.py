...
json_files = list((ROOT_DIR / "data" / "similarity_results"/ "similarity_results_v2").glob("similarity_for_recommend_lsa_*.json"))
if not json_files:
    raise FileNotFoundError("No similarity_for_recommend_lsa_*.jsonl!")
# get the newest one
