...
# 1) Configuration
CONFIG = {
    "INPUT_FILE": "/Users/jasonh/Desktop/02807/PaperTrail/data/preprocess/arxiv-cs-data-with-citations-merged-40.json",
    "OUTPUT_FILE": "/Users/jasonh/Desktop/02807/PaperTrail/data/preprocess/arxiv-cs-data-with-citations-refreshed-40.json",
    ...
    with open(INPUT_FILE, "r", encoding="utf-8") as in_f, \
        ...
        for line in in_f:
            ...
            if new_count == -1 and abstract:
                search_term_ab = normalize_search_term(abstract, max_words=20)
